...
<div class="form-group">
    <label for="courseunit">Lecturers </label>
    <input type="text" class="form-control" id="courseunit" name="courseunit" placeholder="Lecturers" value="<?php echo htmlentities($row['courseUnit']);?>" required />
  </div>  
